                    ...
                    <div class="menu">
                        ...
                        <nav id="main-nav" data-animate="menu-in menu-out">
                            <ul class="main-navigation">
                                <li><a class="m-active" href="index.html" data-text="Home">首頁</a></li>
                                <li><a class="m-anim" href="search.html" data-text="Specials">食譜查詢</a></li>
                                <li><a class="m-anim" href="buy.php" data-text="About">食材購買資料</a></li>
                                <li><a class="m-anim" href="about.php" data-text="Menu Cart">關於我們</a></li>
                                <li><a class="m-anim" href="login.html" data-text="Contact">會員登入/註冊</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
<body>
    ...
    <section id="specials-grid" class="month-specials" data-scroll-reveal="enter from the bottom after 0.9s">
        <div class="container">
            <form action="php/search2.php" method="post">
                <!--
    ...
    <section id="about-us" class="about">
        <div class="container">
            <div class="about-content">
                <h1 class="header-txt scroll-reveal">每日一菜</h1>
