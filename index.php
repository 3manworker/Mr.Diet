...
<body>
            ...
            <div class="a-slide slide1">
                <div class="container">
                    <div class="bottom-section scroll-reveal" data-origin="right" data-distance="20%">
                        <h1 class="header-txt">現代人追求健康飲食的需求越來越高，從買菜到烹調樣樣都自己來，因此我們的初衷是做個簡易的食譜網頁，讓人們在家中能安心煮且煮的好吃</h1>
                        <div class="divider">
            ...
            <div class="a-slide slide2">
                <div class="container">
                    <div class="bottom-section">
                        <h1 class="header-txt">用最簡單的步驟做出最完美的料理</h1>
                        <div class="divider">
                            <!-- Generator: Adobe Illustrator 21.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1930 255.5" style="enable-background:new 0 0 1930 255.5;" xml:space="preserve">
                                <style type="text/css">
    ...
    <section class="category-icons">
        <div class="container">
            <div class="yellow-content">
                <div class="icon">
                    <img class="scroll-reveal" style="width: 75px;height:75px;" data-origin="top" data-distance="0%" src="assets/icon-coffee.png" />
                    <h3 class="scroll-reveal" data-origin="top" data-distance="20%">食譜搜尋</h3>
                    <p class="scroll-reveal" data-distance="0" style="font-size:160%;" data-duration="500">輸入菜色名稱，可以搜尋到食譜作法</p>
                </div>
                <div class="icon">
                    <img class="scroll-reveal" style="width: 75px;height:75px;" data-origin="top" data-distance="20%" src="assets/menu.png" />
                    <h3 class="scroll-reveal" data-origin="top" data-distance="20%">食譜反查</h3>
                    <p class="scroll-reveal" data-distance="0" style="font-size:160%;" data-duration="700">利用食材名稱 搜尋可以使用這些食材所料理的菜色</p>
                </div>
                <div class="icon">
                    <img class="scroll-reveal" style="width: 75px;height:75px;" data-origin="top" data-distance="20%" src="assets/food-cart.png" />
                    <h3 class="scroll-reveal" data-origin="top" data-distance="20%">食材購買地點</h3>
                    <p class="scroll-reveal"  data-distance="0" style="font-size:160%;" data-duration="900">使用會員所在的定位 去搜尋附近可以購買食材的超市</p>
                </div>
            </div>
            <!--.yellow-content-->
        </div>
    ...
    <section id="about-us" class="about">
        <div class="container">
            <div class="row">
                <div class="col-8">
            <div class="about-content66">
                <h1 class="header-txt scroll-reveal">研究動機</h1>
                ...
                <p class="scroll-reveal" data-origin="top" data-distance="10%" style="font-size:130%;" >國民所得的提升，滿足口腹之慾已經不再被認為是奢侈的行為，越來越多人從只為了飽餐一頓，慢慢走上街頭尋找值得朝聖的餐廳，就為了一口為之見的味覺享受。餐廳的數量也倍數成長，為了品牌的經營，減少品質的忽高忽低，維持一致性成為了一大課題，食譜的誕生成為品管的一大指標，大到米其林餐廳，小至單人套房總有他的身影。現在社會的忙碌，手機的使用率遠超過在家悠閒看電視的時間，因此本專題結合各方面的食材等等集合在本專題中提供給大家參考。</p>
            </div>
                </div>
            <div class="col">
            <div class="divider scroll-reveal">
            <img src = "assets/img/logo1.jpg" style="width:500px;height:300px;" >
            </div>
            </div>
