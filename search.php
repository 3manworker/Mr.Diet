        ...
        $(document).ready(function () {
            ...
            <div class="specials-content">
                <div class="special">
                    ...
                    <a href="search3.php"> <!--讓圖片可以點擊不會被css影響-->
                        <img src="assets/img/滑蛋牛肉.jpg" />
                    </a>
                    </div>
                    <div class="special-items spec-01">
                    <a href="search3.php"  style="color:black;">
...
$Q="select mname,ingredient,do from menu where mname='$search'";
$result=$db->query($Q);
$num=$result->num_rows;
if ($num!=0) {
for ($i=0;$i<$num;$i++) {
    $ARAW=$result->fetch_row();
    echo $ARAW[0].$ARAW[1].$ARAW[2]."\n";
}
}
?>
                            </div>
